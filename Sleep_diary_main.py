...
if user_select == "Wake-Time Timestamp":
    ...
    if sys.platform.startswith("win32"):
        ...
        user_warning = pyinputplus.inputYesNo(
            prompt="WARNING: Automatically calling the RScript function to generate the BT Timestamp may not work correctly! If you encountered an error, please run the Step1_Cleaning modified.R manually. Do you wish to proceed? (Y/N):\n"
        )
        if user_warning == "yes":
